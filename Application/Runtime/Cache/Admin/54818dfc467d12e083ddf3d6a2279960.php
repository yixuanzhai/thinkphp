    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="/thinkphp/index.php/Admin/Index/Pages">Pages</a></li>
                <li><a href="posts.html">Posts</a></li>
                <li class="active"><a href="/thinkphp/index.php/Admin/Index/Users">Users</a></li>
            </ul>
...
<header id="header">
    <div class="container">
        <div class="row">
            <div class="col-md-10">
                <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Users
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="/thinkphp/index.php/Admin/Index/Pages" class="list-group-item"><span class="glyphicon glyphicon-list-alt"
                    ...
                    <a href="/thinkphp/index.php/Admin/Index/Users" class="list-group-item"><span
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <input class="form-control" type="text" id="filter" placeholder="Filter Users..."
                                       onkeyup="index.filter()">
                            </div>
                        </div>
                        <br>
                        <table id="userTable" class="table table-striped table-hover">
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><?php echo (date('Y-m-d',strtotime($vo['registration_date']))); ?></td>
                                    <td><?php echo (date('Y-m-d H:i',strtotime($vo['last_login']))); ?></td>
                                    <td id=<?php echo ($vo['username']); ?>><a type="button" class="btn btn-default"
                                                                data-toggle="modal" data-target="#editUser"
                                                                onclick="index.loadUserInfo(this.parentNode.id)">Edit</a>
                                        <input type="button" class="btn btn-danger" value="Delete"
                                               onclick="index.deleteUser(this.parentNode.id)"/></td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" onclick="index.updateUserInfo()">Save changes</button>
                </div>
            </form>
        </div>
    </div>
